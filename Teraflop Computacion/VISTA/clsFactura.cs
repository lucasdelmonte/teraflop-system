...
namespace VISTA
{
    class clsFactura
    {
        public class CreaTicket
        {
            ...
            {                
                string LineEncavesado = "Products          Price     Amount     Total";   // agrega lineas de  encabezados
            ...
            public void TextoDerecha(string par1)               // agrega texto a la derecha
            {
                ticket = "";
                max = par1.Length;
                if (max > 44)                                 // **********
            ...
            public void TextoCentro(string par1)                // agrega texto al centro
            {
                ticket = "";
                max = par1.Length;
                if (max > 44)                                 // **********
            ...
            public void AgregaTotales(string par1, double total)
            {
                ...
                ticket = parte1;
                parte2 = total.ToString("C", nfi); // ("C", nfi) $338,854.40
                max = 44 - (parte1.Length + parte2.Length);
                for (int i = 0; i < max; i++)                // **********
                {
            ...
            public void AgregaArticulo(string Articulo, double precio, int cant, double subtotal) // YO decimal por double 
            {
                if (cant.ToString().Length <= 2 && precio.ToString("c").Length <= 15 && subtotal.ToString("c").Length <= 15) // valida que cant precio y total esten dentro de rango
                {
                    ...
                    if (Articulo.Length > 44)                                 // **********
                    {
                        ...
                        nroEspacios = (15 - subtotal.ToString().Length); //Y
                        espacios = "";
                    ...
                    else
                    {
                        ...
                        //colocar el subtotal a la derecha
                        nroEspacios = (15 - subtotal.ToString().Length);
                        espacios = "";
                ...
                else
                {
                    ...
                    frmErrorOutRange formErrorOutRange = new frmErrorOutRange();
                    result = formErrorOutRange.ShowDialog();
        ...
        #region Clase para enviar a la impresora texto plano
