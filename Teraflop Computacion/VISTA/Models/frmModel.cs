...
namespace VISTA.Features
{
    public partial class frmModel : Form
    {
        ...
        #region constructor
        public frmModel(MODELO.Model miModel, MODELO.ACTION miACTION)
        {
            InitializeComponent();
        ...
        private void btnAccept_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                oModel.NameModel = txtName.Text;

                if (ACTION == MODELO.ACTION.ADD)
                {
                    cModels.Add_Model(oModel);
                }
                else
                {
                    cModels.Modify_Model(oModel);
                }
